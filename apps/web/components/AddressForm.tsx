      ...
      <>
        <div className="flex h-full w-full font-poppins">
            <div className="flex flex-col gap-2 py-2 text-blog-black 
                ...
                <div className="address-form-container [&_.MuiFormControl-root]:mb-3 [&_.MuiInputBase-root]:bg-white [&_.MuiInputBase-root]:dark:bg-fun-blue-700 [&_.MuiInputLabel-root]:text-gray-600 [&_.MuiInputLabel-root]:dark:text-blog-white [&_.MuiOutlinedInput-notchedOutline]:border-gray-300 [&_.MuiOutlinedInput-notchedOutline]:dark:border-fun-blue-500 [&_.MuiInputBase-input]:text-blog-black [&_.MuiInputBase-input]:dark:text-blog-white">
                    <JsonForms
                        schema={schema}
                        uischema={uischema}
                        data={data}
