            ...
            <div className="w-full px-4 sm:px-6 lg:px-8">
                ...
                {Array.isArray(products) && products.filter(Boolean).filter(p => p.id).map((product: PRODUCT) => {
                    ...
                    return (
                        ...
                        >
                            <article className="relative flex flex-col bg-white dark:bg-fun-blue-600 text-blog-black dark:text-blog-black rounded-3xl overflow-hidden h-full shadow-lg transition-all duration-200 hover:-translate-y-1 hover:brightness-125 hover:shadow-xl active:scale-95">
                            ...
                            <div className="p-4 flex-1 flex flex-col justify-between">
                                <div>
                                    <h3 className="text-lg font-semibold text-blog-black dark:text-blog-black">
                                        <Link href={`/product-detail/${product.id}`} className="hover:underline underline-offset-2 text-blog-black dark:text-blog-black">
                                            {nameTrimmed}
                                        </Link>
                                    </h3>
                                    {descriptionTrimmed && <p className="mt-2 text-sm text-blog-black dark:text-blog-black">{descriptionTrimmed}</p>}
                                </div>

                                <div className="mt-4 flex items-center justify-between">
                                    <div className="text-sm text-blog-black dark:text-blog-black">
                                        <CurrencyPriceComponent price={product.price} />
                                    </div>
                                    <div className="text-xs text-blog-black dark:text-blog-black">{createdAtDateFormat}</div>
                                </div>
                ...
                {!createProduct && (
                    ...
                    >
                        <div 
                            className="w-full h-full min-h-[400px] flex items-center justify-center bg-white dark:bg-fun-blue-600 text-blog-black dark:text-blog-black rounded-3xl shadow-lg transition-all duration-200 hover:-translate-y-1 hover:brightness-125 hover:shadow-xl active:scale-95"
                            style={{
                                touchAction: 'manipulation',
                                WebkitTapHighlightColor: 'rgba(0,0,0,0)'
                            }}
                        >
                            <div className="flex flex-col gap-2 justify-center items-center">
                                ...
                                />
                                <div className="text-lg font-semibold pointer-events-none text-blog-black dark:text-blog-black">
                ...
                {createProduct && (
                    <div key="create-form" className="col-span-1 sm:col-span-2 md:col-span-2 lg:col-span-2 w-full pb-5 rounded-3xl shadow-lg overflow-visible group transition-transform duration-200 active:scale-95">
                        <div className="w-full p-4 bg-white dark:bg-fun-blue-600 dark:text-blog-black rounded-3xl">
