...
function UserProfilePage({ userProfile, posts }) {
  ...
  return (
    <div className="min-h-screen bg-blog-white dark:bg-fun-blue-500">
      {/* Hero Section */}
      <div className="bg-blog-white dark:bg-fun-blue-500 border-b border-gray-200 dark:border-fun-blue-400">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Navigation Tabs */}
        <div className="border-b border-gray-200 dark:border-fun-blue-400 mb-8">
        ...
        <div className="space-y-4">
          {posts && posts.length > 0 ? (
            ...
            <div className="text-center py-12">
              <div className="bg-gray-100 dark:bg-fun-blue-400 rounded-full w-24 h-24 flex items-center justify-center mx-auto mb-4">
                <svg className="w-12 h-12 text-gray-400 dark:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="space-y-2">
                {userProfile?.website && (
                  <a
                    ...
                    className="flex items-center text-fun-blue-600 dark:text-fun-blue-300 hover:text-fun-blue-500 dark:hover:text-white"
                  >
