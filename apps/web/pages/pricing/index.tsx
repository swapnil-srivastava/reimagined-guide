...
const Pricing = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col items-center gap-2 font-poppins mt-10 px-4 bg-blog-white dark:bg-fun-blue-500 text-blog-black dark:text-blog-white">
        {/* Title */}
        ...
        {/* Pricing cards */}
        <div className="flex lg:flex-row flex-col gap-5 m-10 text-blog-black dark:text-blog-white">
            {/* Pricing card 1 */}
          <article className="w-80 mx-10 p-10 bg-blog-white dark:bg-fun-blue-600 dark:text-blog-white hover:rounded-3xl rounded-3xl drop-shadow-lg hover:drop-shadow-xl hover:brightness-125">
              <div className="flex flex-col">
                ...
                <p className="font-thin text-xs leading-loose text-blog-black">
                  <FormattedMessage
            ...
            {/* Pricing card 2 */}
            <article className="w-80 mx-10 p-10 bg-fun-blue-100 dark:bg-blog-white card--white hover:rounded-3xl rounded-3xl drop-shadow-lg hover:drop-shadow-xl hover:brightness-125 text-blog-black">
            <div className="flex flex-col">
                <h2 className="font-bold leading-loose text-blog-black dark:text-blog-white">
                  <FormattedMessage
                ...
                <p className="font-thin text-xs leading-loose text-blog-black dark:text-blog-white">
                  <FormattedMessage
                ...
                <p className="text-4xl text-center leading-loose text-blog-black dark:text-blog-white">€1,000</p>
                {/* button section */}
              ...
              <div className="flex flex-col leading-loose text-sm lg:text-md">
                <div className="flex gap-2">
                  <div className="text-blog-black dark:text-blog-white"><FontAwesomeIcon icon={faCheck} /></div>
                  <div className="text-blog-black dark:text-blog-white">
                    <FormattedMessage
            ...
            <article className="w-80 mx-10 p-10 bg-blog-white dark:bg-fun-blue-600 dark:text-blog-white hover:rounded-3xl rounded-3xl drop-shadow-lg hover:drop-shadow-xl hover:brightness-125">
              <div className="flex flex-col">
                <h2 className="font-bold leading-loose text-blog-black">
                  <FormattedMessage
        ...
        <section className="bg-blog-white text-blog-black dark:bg-fun-blue-600 dark:text-blog-white py-12 sm:py-24 lg:py-32 rounded-lg mb-12 w-full max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-7xl">
            <div className="mx-auto max-w-2xl sm:text-center px-4">
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold tracking-tight text-blog-black">
                <FormattedMessage
            ...
            <div className="mx-auto mt-8 sm:mt-16 lg:mt-20 max-w-2xl rounded-3xl ring-1 ring-gray-200 dark:ring-fun-blue-500 lg:mx-0 lg:flex lg:max-w-none">
              <div className="p-8 sm:p-10 lg:flex-auto">
                <h3 className="text-2xl font-bold tracking-tight text-blog-black">
                  <FormattedMessage
                ...
                <p className="mt-6 text-base leading-7 text-blog-black">
                  <FormattedMessage
                ...
                <div className="mt-10 flex items-center gap-x-4">
                  <h4 className="flex-none text-sm font-semibold leading-6 text-blog-black">
                    <FormattedMessage
                ...
                <ul
                  role="list"
                  className="mt-8 grid grid-cols-1 gap-4 text-sm leading-6 text-blog-black sm:grid-cols-2 sm:gap-6"
                >
                ...
                <div className="rounded-2xl bg-gray-50 dark:bg-fun-blue-700 py-10 text-center ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16">
                  <div className="mx-auto max-w-xs px-8">
                    ...
                    <p className="mt-6 flex items-baseline justify-center gap-x-2">
                      <span className="text-5xl font-bold tracking-tight text-black">€3500</span>
                      <span className="text-sm font-semibold leading-6 tracking-wide text-black">EURO</span>
                    </p>
                    <CheckoutButton 
