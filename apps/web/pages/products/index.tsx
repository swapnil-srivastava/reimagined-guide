                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3 flex-1 min-w-0">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="text-blog-black dark:text-blog-white text-xs sm:text-sm hidden sm:block">
                          <FormattedMessage
                    ...
                    <div className="flex items-center gap-3 sm:gap-4 flex-shrink-0">
                      <div className="text-right">
                        <p className="text-blog-black dark:text-blog-white text-xs hidden sm:block">
                          <FormattedMessage
            ...
            <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
              ...
              <div className="flex flex-wrap gap-4 items-center">
                ...
                <button
                  ...
                  className="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-black active:bg-gray-50 dark:active:bg-gray-600 focus:ring-2 focus:ring-blue-500 shadow-md dark:shadow-lg dark:shadow-black/20 transition-all duration-200 cursor-pointer touch-manipulation md:hover:bg-gray-50 md:dark:hover:bg-fun-blue-600 md:hover:shadow-lg"
                >
                ...
                <select
                  ...
                  className="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-black focus:ring-2 focus:ring-blue-500 shadow-md dark:shadow-lg dark:shadow-black/20 hover:shadow-lg dark:hover:shadow-xl dark:hover:shadow-black/30 focus:shadow-xl dark:focus:shadow-2xl dark:focus:shadow-black/40 transition-shadow duration-200 cursor-pointer"
                >
                  <option value="name">
