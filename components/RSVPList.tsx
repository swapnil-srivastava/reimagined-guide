    ...
    return (
      <div className={`bg-white dark:bg-fun-blue-600 rounded-lg p-3 sm:p-4 drop-shadow-lg hover:drop-shadow-xl transition-all duration-300 ${isClickable ? 'cursor-pointer hover:bg-gray-50 dark:hover:bg-fun-blue-700' : ''}`}>
        ...
        <div className="grid grid-cols-3 gap-2 sm:gap-3">
          {/* Attending Card */}
          <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-2 sm:p-3 text-center border border-green-200 dark:border-green-800">
          ...
          {/* Total Guests Card */}
          <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-2 sm:p-3 text-center border border-blue-200 dark:border-blue-800">
            <div className="flex items-center justify-center mb-1">
          ...
          {/* Not Attending Card */}
          <div className="bg-red-50 dark:bg-red-900/20 rounded-lg p-2 sm:p-3 text-center border border-red-200 dark:border-red-800">
            <div className="flex items-center justify-center mb-1">
                  ...
                  {rsvps.map((rsvp) => (
                    <div key={rsvp.id} className="bg-gray-50 dark:bg-fun-blue-700 rounded-lg p-4 border border-gray-200 dark:border-fun-blue-500">
                      <div className="flex items-start justify-between mb-3">
                        <div>
                          <h5 className="font-semibold text-blog-black dark:text-blog-white">{rsvp.name}</h5>
                          <div className="flex items-center gap-4 text-sm text-gray-600 dark:text-gray-300 mt-1">
                            <div className="flex items-center gap-1">
                              <FontAwesomeIcon icon={faEnvelope} className="text-xs" />
                              <a href={`mailto:${rsvp.email}`} className="hover:text-fun-blue-500 transition-colors">
                                {rsvp.email}
                              </a>
                            </div>
                            {rsvp.phone && (
                              <div className="flex items-center gap-1">
                                ...
                                <a href={`tel:${rsvp.phone}`} className="hover:text-fun-blue-500 transition-colors">
                                  {rsvp.phone}
                                </a>
                              </div>
                            )}
                        ...
                        <div className="space-y-2 text-sm">
                          ...
                          {rsvp.dietary_restrictions && (
                            <div>
                              ...
                              <p className="text-blog-black dark:text-blog-white mt-1">{rsvp.dietary_restrictions}</p>
                            </div>
                          )}
                          ...
                          {rsvp.special_requests && (
                            <div>
                              ...
                              <p className="text-blog-black dark:text-blog-white mt-1">{rsvp.special_requests}</p>
                            </div>
                          )}
                        </div>
                      )}
